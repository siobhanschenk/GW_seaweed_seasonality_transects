...
We record the seaweed abundance in quadrats (1 m by 1 m squares) that we place at the same spots in a rocky intertidal zone in Stanley Park (Vancouver British Columbia).
We sample once a month.
...
This document outlines our current engagement with the Indigenous people who's land this research is conducted on and provides more background  regarding why the study was conducted. 
/


// About the protocol.pdf document //

This pdf document explains our sampling procedure and indicyaed the location of the transects at Girt in a Westuit (Empress Figurehead) Stanley Park, Vancouver, British Columbia, Canada
/
...
transect_id: the numerical identification of the transect. Note, we started with 5 transects total by cut it down to 3 for all sampling events after 2022-04-20. 
distance_along_transect_m: the distance away from the seawall in m. Quadrat 1 is from 0 to 1 m, quadrat 2 is from 5 to 6 m and so on (see protocol.pdf). Please not that this is not the same as tide height. At this time, we have not yet calculated which quadrats are exposed to air at which tide height.
...
The numbers in the seaweed genus_species columns is the estimated percent cover of that seaweed. Since seaweed overlap, there can be over 100% cover. 
Estimated percent cover below 1% was rounded to 1%. For percent cover between 1 and 5, we reccoded to the nearest percent. Above 5%, we recorded the percent cover to the nearest interval of 5 (e.g 3% was recorded as 3%, 7% was recorded as 5%, and 9% was recorded as 10%).  
/
...
These are truly opportunistic observations and kelp (Laminariales) reproductive tissue is easy to spot compared to other seaweeds. 
/