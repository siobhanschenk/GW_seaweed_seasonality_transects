...
ui <- fluidPage(
    ...
    sidebarLayout(            
      ...
      labs at the Univeristy of British Columbia, Vancouver Campus.</p>',
                 ...
                 '<p>For information about the study, see our <strong>preprint on <a href="https://www.biorxiv.org/content/10.1101/2024.09.12.612793v1" target="_blank">BioRXiv</a></strong>. 
      ...
      <i>varoonp@student.ubc.ca</i> and <i>sschenk@student.ubc.ca</i></p>'),
            ...
            HTML('<h3>Acknowledgements </h3>',
                ...
                <p> Volunteers who donated their time to help us collect these data. In particular: A. Choinski, A. Jackman, A. Simon, B. Clarkston, C. Wardrop, E. Evans,
                 E. Jourdain, E. Menchions, E. Kohn, E. Porcher, G. Ainsworth-Cruickshank, N. Salland, MJ. Herrin, P. Lund, R. Burns, R. Perovich, R. Ogushi, V. Billy.</p>'),
            br(),
